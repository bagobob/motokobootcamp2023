...
actor day2 {
    ...
    // 1. Write a function **average_array** that takes an array of integers and 
  ...
  // 5. Write a function find_duplicates that takes an array of natural numbers and returns a new array containing all duplicate numbers. The order of the elements in the returned array should 
  // be the same as the order of the first occurrence in the input array.
};